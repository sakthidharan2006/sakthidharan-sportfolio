    ...
    <section id="experience" className="py-20 md:py-32 relative" ref={ref}>
      <div className="section-container">
        ...
        >
          ...
          <TiltCard>
            <div
              className="card-notched card-notched-lg relative overflow-hidden bg-card/40 backdrop-blur-xl group"
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div className={`md:w-1/2 ${index % 2 === 0 ? "md:pr-16" : "md:pl-16"}`}>
                  <TiltCard>
                    <div
                      className="card-notched relative bg-card/50 backdrop-blur-xl p-5 hover:opacity-100 transition-colors group overflow-hidden"
