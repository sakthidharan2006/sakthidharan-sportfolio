  ...
  const [messages, setMessages] = useState<Msg[]>([
    {
      role: "assistant",
      content:
        "👋 Hi! I'm **Sakthi-Bot**. Ask me anything about Sakthidharan's skills, projects, or how to get in touch!",
    },
  ]);
          ...
          >
            ...
            <div className="flex items-center gap-3 px-4 py-3 border-b border-border/50 bg-gradient-to-r from-primary/10 to-accent/10">
              ...
              <div className="flex-1">
                <div className="font-mono text-sm font-bold text-foreground">Sakthi-Bot</div>
